...
(IsNull(c1.ThreeYearGrowthmavg3,0) + IsNull(c2.ThreeYearGrowthmavg3,0) + IsNull(c3.ThreeYearGrowthmavg3,0) + IsNull(c4.ThreeYearGrowthmavg3,0) + IsNull(c5.ThreeYearGrowthmavg3,0) + IsNull(c6.ThreeYearGrowthmavg3,0))/6 as neighborThreeYearGrowthmavg3,
(IsNull(c1.ThreeYearGrowth,0) + IsNull(c2.ThreeYearGrowth,0) + IsNull(c3.ThreeYearGrowth,0) + IsNull(c4.ThreeYearGrowth,0) + IsNull(c5.ThreeYearGrowth,0) + IsNull(c6.ThreeYearGrowth,0))/6 as neighborThreeYearGrowth
